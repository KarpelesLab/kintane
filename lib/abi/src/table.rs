...
crate::syscalls! {
    ...
    35 => fn socket_send_to(socket: Handle, address: u64, bytes: UserPtr, len: usize, timeout_ns: u64);
    ...
    36 => fn socket_recv_from(socket: Handle, buf: UserPtr, cap: usize, from: UserPtr, timeout_ns: u64);
}
