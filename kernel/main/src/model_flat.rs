...
pub fn files_statfs_check(_c: &dyn EarlyConsole) -> Check {
    Check::Passed
}

pub fn files_list_check(_c: &dyn EarlyConsole) -> Check {
    Check::Passed
}
...
pub fn linux_sockets_check(_c: &dyn EarlyConsole) -> Check {
    Check::Passed
}
