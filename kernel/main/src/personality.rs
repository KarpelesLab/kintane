...
fn dispatch(
    ...
    match call {
        ...
        Call::Sendto => socket::sendto(slot, a0, a1, a2, a3, a4, a5),
        Call::Recvfrom => socket::recvfrom(slot, a0, a1, a2, a3, a4, a5),
        Call::Sendmsg => socket::sendmsg(slot, a0, a1, a2),
        Call::Recvmsg => socket::recvmsg(slot, a0, a1, a2),
